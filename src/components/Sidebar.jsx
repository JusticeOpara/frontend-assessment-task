...
const List = ({ image, text, digit }) => {
    return (
        ...
        <div className=' h-[24px] w-full flex flex-row pl-0 items-center gap-4 bg-gray-100'>
            {image}
            <p>{text}</p>
            {digit}
...
export default function Sidebar() {
    return (
        ...
        <div className='bg-gray-400 w-[296px] h-[1024px] shadow flex flex-col items-center justify-between overflow-scroll '>
            <div>
                ...
                <div className="inline-flex flex-col items-start gap-[24px] bg-cyan-600">
                    ...
                    <List
                        ...
                        text="orders"
                        digit={<div className="flex rounded-[500px] bg-[#FFCC91] w-6 pt-[4px] pb-[8px] pr-[5px] pl-[8px] items-center justify-center">8</div>}
                    />
            ...
            <div className='flex justify-end flex-col'>
                ...
                <div className='inline-flex items-start gap-3 w-[118px] h-[46px] bg-green-200 mb-4'>
